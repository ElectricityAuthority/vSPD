...
* Source:               http://github.com/ElectricityAuthority/vSPD
*                       http://www.emi.ea.govt.nz/Tools/vSPD
* Contact:              Forum: http://www.emi.ea.govt.nz/forum/
*                       Email: emi@ea.govt.nz
* Modified on:     19 Sep 2019
* Feature added: Wind Offer
* Last modified on:     11 Nov 2020
* Feature added: Replacing invalid prices after SOS1 (6.1.3)
*=====================================================================================
...
* TN - Replacing invalid prices after SOS1
  ...
  numberofbusSOSinvalid(tp)                           'number of buses with invalid bus prices after SOS1 solve --> used to check if invalid prices can be improved  --> numberofbusSOSinvalid reduces after each loop '
  ;
...
*           TN - Replacing invalid prices after SOS1 - Flag period that is resolved using SOS1
...
*   6f0. Replacing invalid prices after SOS1 (6.1.3)----------------------------
    if ( vSPD_SOS1_solve(tp),
        ...
        While ( sum[b, busSOSinvalid(tp,b)] < numberofbusSOSinvalid(tp) ,
            ...
            display vSPD_SOS1_solve,  numberofbusSOSinvalid, busSOSinvalid;
...
*   6f0. Replacing invalid prices after SOS1 (6.1.3) End -----------------------
